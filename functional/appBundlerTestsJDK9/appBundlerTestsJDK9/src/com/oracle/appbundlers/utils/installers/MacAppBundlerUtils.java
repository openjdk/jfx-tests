 ...
 */
public class MacAppBundlerUtils extends MacAbstractBundlerUtils {

    public MacAppBundlerUtils() {
        super(BundleType.IMAGE, BundlerUtils.MAC_APP);
    }
    ...
    public Path getInstalledAppRootLocation(AppWrapper app,
        ...
        return app.getBundlesDir().resolve(applicationTitle + ".app");
    }
